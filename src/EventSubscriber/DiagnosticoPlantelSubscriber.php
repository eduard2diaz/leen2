...
class DiagnosticoPlantelSubscriber  implements EventSubscriber
{
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof DiagnosticoPlantel) {
            ...
            if (null!=$nombreArchivo)
                $entity->setDiagnosticoarchivo($nombreArchivo);
        }
    }
    ...
    public function preRemove(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof DiagnosticoPlantel) {
            ...
            $ruta=$directory . DIRECTORY_SEPARATOR . $entity->getDiagnosticoarchivo();
